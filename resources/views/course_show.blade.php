...
@section('content')
    ...
    <main>
        <section id="hero_in" class="courses"
                 style="background : url({{asset("storage/".$course->photo)}}) center center no-repeat;">
                                ...
                                @foreach($course->chapters as $chapter)
                                    <div class="card">
                                        <div class="card-header" role="tab" id="headingOne">
                                            <h5 class="mb-0">
                                                <a data-toggle="collapse" href="#{{$chapter->id}}" aria-expanded="true"
                                                   aria-controls="{{$chapter->id}}"><i
                                                            class="indicator ti-minus"></i> {{$chapter->name}}</a>
                                            </h5>
                                        </div>

                                        <div id="{{$chapter->id}}" class="collapse show" role="tabpanel"
                                                    ...
                                                    <ul>
                                                        @foreach($chapter->lessons as $lesson)
                                                            <li>
                                                                ...
                                                                @endif
                                                                <a href="{{$lesson->video}}" data-var1="{{$lesson->id}}"
